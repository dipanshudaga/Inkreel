...
export default async function Home() {
  const [trendingWatch, trendingRead] = await Promise.all([
    getTrendingWatch(1).then(res => res.slice(0, 5)),
    getTrendingBooks(0).then(res => res.slice(0, 5))
  ]);
      ...
      <div className="flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-8">
          <div className="flex items-center justify-between border-b border-[#1A1A1A] pb-4">
            <h2 className="text-2xl font-serif font-medium text-traced-dark italic m-0">Watch</h2>
            <Link href="/watch" className="text-xs font-sans uppercase tracking-widest text-[#737373] hover:text-traced-dark transition-colors font-semibold">
              View Your Diary
            </Link>
          </div>
        ...
        <div className="flex flex-col gap-8">
          <div className="flex items-center justify-between border-b border-[#1A1A1A] pb-4">
            <h2 className="text-2xl font-serif font-medium text-traced-dark italic m-0">Read</h2>
            <Link href="/read" className="text-xs font-sans uppercase tracking-widest text-[#737373] hover:text-traced-dark transition-colors font-semibold">
              View Your Diary
            </Link>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-8 gap-y-12">
