...
export function ProgressTracker({ 
  ...
  return (
    <div className="py-12 px-16 border-b-hairline flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-6">
                <button 
                  ...
                  className="size-8 flex items-center justify-center border-hairline hover:bg-traced-dark hover:text-white transition-colors"
                >
                  <Minus size={14} />
                </button>
      ...
      <button 
        className="self-start py-3 px-8 bg-traced-dark text-white font-sans font-bold text-[11px] uppercase tracking-widest hover:bg-traced-accent transition-colors"
        onClick={() => {
